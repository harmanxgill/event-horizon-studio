...
| Piece | Status | Notes |
| --- | --- | --- |
| [001 - The Last Orbit](https://github.com/harmanxgill/event-horizon-studio/tree/main/pieces/001_last_orbit "https://github.com/harmanxgill/event-horizon-studio/tree/main/pieces/001_last_orbit") | v017 | Equal-mass binary black holes in the final orbit before merger. |
...
```bash
python pieces/001_last_orbit/experiments/v017_outgoing_wave.py --width 512 --height 512
```
