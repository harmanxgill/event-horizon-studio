...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v018_quadrupolar_field.png"
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v018_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v018 - quadrupolar field.", DEFAULT_OUTPUT)
...
def main() -> None:
    args = parse_args()
    render = phase_series if args.series else v018_rgb
    rgb = render(
        width=args.width,
        height=args.height,
        a=args.a,
