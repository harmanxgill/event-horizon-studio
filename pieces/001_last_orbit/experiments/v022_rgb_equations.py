...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v022_rgb_equations.png"
...
def v022_field(
    ...
    return compress_intensity(raw, tone=tone, gamma_l=gamma_l, p_l=p_l, k_l=k_l)
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v022_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v022 - RGB equations.", DEFAULT_OUTPUT)
