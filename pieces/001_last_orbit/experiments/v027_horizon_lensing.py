...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v027_horizon_lensing.png"
...
def v027_rgb(
    ...
    **field_parameters,
    ...
    level = v027_field(x, y, **field_parameters)
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v027_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v027 - horizon lensing.", DEFAULT_OUTPUT)
...
def main() -> None:
    ...
    if series:
        ...
        rgb = v027_rgb(width, height, phase=phase, **options)
