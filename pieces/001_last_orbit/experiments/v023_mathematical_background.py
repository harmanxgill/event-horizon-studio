...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v023_mathematical_background.png"
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v023_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v023 - mathematical background.", DEFAULT_OUTPUT)
