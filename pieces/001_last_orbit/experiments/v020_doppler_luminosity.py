...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v020_doppler_luminosity.png"
...
def v020_field(
    ...
    return intensity * modulation * (1.0 - silhouette)
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v020_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v020 - Doppler-inspired luminosity.", DEFAULT_OUTPUT)
