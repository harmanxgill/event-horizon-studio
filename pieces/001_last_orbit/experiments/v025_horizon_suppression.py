...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v025_horizon_suppression.png"
...
def v025_field(
    ...
    return suppression * (level + background)
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v025_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v025 - horizon suppression.", DEFAULT_OUTPUT)
