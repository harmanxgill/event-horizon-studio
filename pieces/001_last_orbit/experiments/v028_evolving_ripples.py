...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "v028_evolving_ripples.png"
...
def v028_field(
    ...
    intensity = suppression * (rings + halo + bridge + tail + potential) * boost
...
def v028_rgb(
    ...
    **field_parameters,
    ...
    level = v028_field(x, y, **field_parameters)
...
def phase_series(
    ...
    **kwargs,
    ...
    tiles = [v028_rgb(width, height, phase=phase, **kwargs) for phase in phases]
...
def parse_args() -> argparse.Namespace:
    parser = experiment_parser("Render v028 - evolving ripples.", DEFAULT_OUTPUT)
...
def main() -> None:
    ...
    if series:
        ...
        rgb = v028_rgb(width, height, phase=phase, **options)
